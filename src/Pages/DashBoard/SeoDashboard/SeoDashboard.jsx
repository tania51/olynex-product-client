...
const SeoDashboard = () => {
    ...
    const finalReviewTask = reviewTask && reviewTask.filter(signleTask => signleTask.reviewToBoss === 'reviewToBoss' || signleTask.sendToMockupFromBoss === 'send-to-seo-from-boss')
    ...
    const mockUpHandeler = (task) => {
        ...
        const newTask = {
            id: task._id,
            sendToBossFromSEO: 'send-to-boss-from-seo'
        }
